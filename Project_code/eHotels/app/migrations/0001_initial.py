    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chain_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.hotel_chain')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('username', models.CharField(error_messages=Array['unique': 'A user with that username already exists.'], help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=50, null=True), size=None)),
            ...
            options=Array[
                'unique_together': Array[('room_number', 'hotel_id')],
            ],
        ),
    ]
